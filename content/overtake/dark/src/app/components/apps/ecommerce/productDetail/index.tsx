      ...
      {product ? (
        <>
          <div className="flex gap-2 items-center">
            <Badge className="rounded-md" color={"success"}>{product.stock == true ? 'In Stock' : ' Out Of Stock'}</Badge>
          ...
          <div className="flex gap-3 items-center mb-6">
            <Button color={"primary"} className="px-6 rounded-md" onClick={handleAddToCart}>
              Buy now
            </Button>
            <Button color={"error"} className="px-6 rounded-md" onClick={handleAddToCart}>
              Add to Cart
            </Button>
          </div>
