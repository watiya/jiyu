      ...
      <div className="container-md mx-auto px-4 lg:py-24 py-12">
        <div className="grid grid-cols-12 lg:gap-30 gap-6">
          ...
          <div className="lg:col-span-4 col-span-12">
            <div className="overflow-hidden rounded-tw bg-primary relative p-30 after:absolute after:bg-[url('/images/frontend-pages/background/contact-icon.png')] after:bg-no-repeat after:bg-right-top after:top-0 after:right-0 after:w-[325px] after:h-[325px]">
