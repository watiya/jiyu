  ...
  return (
    <>
      ...
      >
        <Navbar
          fluid
          className={`rounded-none bg-transparent dark:bg-transparent  ${layoutType == "horizontal" ? "container mx-auto py-4 sm:px-5 px-4" : "py-4 sm:px-30 px-4"
            ...
            <div className="flex gap-3 items-center relative">
              ...
              {layoutType != "horizontal" ? (
                <span
                  ...
                  className="h-10 w-10 xl:flex hidden  hover:text-primary hover:bg-lightprimary rounded-full justify-center items-center cursor-pointer"
                >
                  <Icon icon="solar:hamburger-menu-line-duotone" height={21} />
                </span>
              ) : null}
