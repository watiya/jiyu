    ...
    <>
                    ...
                    <Table.Row key={index}>
                      ...
                      <Table.Cell className="whitespace-nowrap">
                        <div className="flex gap-2 text-sm items-center text-darklink font-medium">
                          {item.stock ? (
                            <Badge color={"success"} className="h-2 w-2 p-0 rounded-md"></Badge>
                          ) : (
                            <Badge color={"error"} className="h-2 w-2 p-0 rounded-md"></Badge>
                          )}
      ...
      >
        ...
        <Modal.Footer className="flex justify-center">
          <Button color={"error"} className="rounded-md" onClick={handleConfirmDelete}>
            Delete
          </Button>
          <Button onClick={handleCloseDeleteDialog} color={"lighterror"} className="rounded-md">
            Cancel
          </Button>
        </Modal.Footer>
      </Modal>
      ...
      >
        ...
        <ModalFooter>
          <Button color={"primary"} className="rounded-md" onClick={handleSaveEdit}>
            Save
          </Button>
          <Button onClick={handleCloseEditModals} color={"lighterror"} className="rounded-md">
            Cancel
          </Button>
        </ModalFooter>
      </Modal>
