...
const customTheme = createTheme(
  {
    ...
    dropdown: {
      ...
      floating: {
        ...
        item: {
          ...
          base: "flex w-full cursor-pointer items-center justify-start px-4  py-2 text-sm text-ld hover:text-primary dark:hover:!text-primary bg-hover  focus:bg-hover focus:outline-hidden hover:bg-lighthover dark:hover:bg-darkmuted",
          icon: "mr-2 h-4 w-4",
        },
        style: {
    ...
    table: {
      ...
      row: {
        ...
        hovered: "hover:bg-lighthover dark:hover:bg-darkmuted",
        striped:
   ...
   star: {
    ...
    accordion: {
      root: {
        base: "divide-y divide-transparent dark:divide-transparent border-transparent  dark:border-transparent",
        flush: {
  ...
  toggle: {
    ...
    navbar: {
      ...
      link: {
        base: " py-1.5 px-4 text-base hover:text-primary dark:hover:text-primary text-darklink hover:bg-lightprimary rounded-full flex justify-center items-center cursor-pointer ",
        active: {
    ...
    sidebar: {
      ...
      item: {
        base: "flex items-center cursor-pointer justify-center rounded-lg px-4 py-3 mb-1 gap-3  text-[15px]! text-start  leading-[normal] font-normal text-link hover:bg-lightprimary dark:hover:bg-lightprimary hover:text-primary dark:text-white  dark:hover:text-primary",
        content: {
      ...
      collapse: {
        button:
          "group flex gap-3 items-center  rounded-lg px-4 py-3 mb-1 text-[15px] text-start truncate leading-[normal] font-normal text-link hover:bg-lightprimary hover:text-primary dark:text-white w-full dark:hover:text-primary cursor-pointer",
        icon: {
